...
idx2 = [2,1,4,3]';
GEOM.ROTOR.matLOCATION = GEOM.ROTOR.matLOCATION(idx2,:)-GEOM.VEH.vecCG;
...
GEOM.VEH.ARM.matBEGIN = GEOM.VEH.ARM.matBEGIN(idx2,:)-GEOM.VEH.vecCG;
...
GEOM.VEH.ARM.matEND = GEOM.VEH.ARM.matEND(idx2,:)-GEOM.VEH.vecCG;
% Fuselage body
...
GEOM.VEH.BODY.matBEGIN = GEOM.VEH.BODY.matBEGIN(:,[1 3 2])-GEOM.VEH.vecCG;
...
GEOM.VEH.BODY.matEND = GEOM.VEH.BODY.matEND(:,[1 3 2])-GEOM.VEH.vecCG;
...
GEOM.VEH.MOTOR.matBEGIN = GEOM.VEH.MOTOR.matBEGIN(idx2,:)-GEOM.VEH.vecCG;
...
GEOM.VEH.MOTOR.matEND = GEOM.VEH.MOTOR.matEND(idx2,:)-GEOM.VEH.vecCG;
