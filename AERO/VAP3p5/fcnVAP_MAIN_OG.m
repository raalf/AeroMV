function [OUTP, COND, INPU, FLAG, MISC, SURF, VEHI, VISC, WAKE] = fcnVAP_MAIN_OG(filename, VAP_IN)

%This is the old fcnVAP_MAIN before dividing it into seperate functions for
%initialization and timestepping
